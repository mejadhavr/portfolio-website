        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
            <div style={{ position: 'relative' }}>
              <img src="/images/logo.png" alt="Avatar" style={{ width: 44, height: 44, borderRadius: '50%', objectFit: 'cover', background: '#000', border: '1px solid rgba(200,169,110,0.3)' }} />
        ...
        <div className="chat-scroll" style={{ flex: 1, padding: '24px', overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div key={i} style={{ display: 'flex', gap: 12, alignSelf: m.role === 'user' ? 'flex-end' : 'flex-start', maxWidth: '85%' }}>
              ...
              {m.role === 'ai' && (
                <div style={{ flexShrink: 0 }}>
                  <img src="/images/logo.png" alt="AI" style={{ width: 28, height: 28, borderRadius: '50%', border: '1px solid rgba(255,255,255,0.1)' }} />
                </div>
              )}
          ...
          {isTyping && (
             <div style={{ display: 'flex', gap: 12, alignSelf: 'flex-start', maxWidth: '85%' }}>
                <div style={{ flexShrink: 0 }}>
                  <img src="/images/logo.png" alt="AI" style={{ width: 28, height: 28, borderRadius: '50%', border: '1px solid rgba(255,255,255,0.1)', opacity: 0.5 }} />
                </div>
                <div style={{
